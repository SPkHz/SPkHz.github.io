...
Gamma_S_Design_2_unnorm = Gamma_S_Design_1_best;
Gamma_S_Design_2 = conformal_normalize(Gamma_S_Design_2_unnorm);
...
[Gamma_L_Pn_Design_2, ~, ~, ~, ~] = Gamma_Points_finder(Gamma_ML, rvo_cpu, Cvo_cpu);
