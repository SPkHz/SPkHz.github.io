...
%% Figure #1 --- Initial Pole Layout for Z-Func
n_fig = n_fig + 1;
figure(n_fig)
...
%-------------------------------------------------------------------
s2p_file = 'C:\Users\Adminimal\Documents\MATLAB\WNE\WNE_SP25\EE456\EE456_Design_Projects\EE456_Design_Project_3_v3\Design_3_IMN_OMN_Placzek.s2p';
...
%% Figure #8 -- Real and Imaginary Poles
n_fig = n_fig + 1;
figure(n_fig)
zplane(sz2, sp2)
hold on
...
%% Figure #11 -- |S21|&|S11|dB -- MatlabSim
n_fig = n_fig + 1;
figure(n_fig)
plot(freq/G, S21_OMN_dB, 'r', 'linewidth', 9)
hold on
...
set(gca, 'linewidth', 2.5)
%------------------------------------------------------------------
%% Figure #12 -- |S21|dB -- OMN MatlabSim
n_fig = n_fig + 1;
figure(n_fig)
plot(freq/G, S21_OMN_dB, 'r', 'linewidth', 9)
hold on
...
set(gca, 'linewidth', 2.5)
%------------------------------------------------------------------
%% Figure #13 -- |S21|dB -- ADS vs Matlab
n_fig = n_fig + 1;
figure(n_fig)
...
%-------------------------------------------------------------------
%% Figure #14 -- |S11|dB -- ADS vs Matlab
n_fig = n_fig + 1;
figure(n_fig)
...
%-------------------------------------------------------------------
%%% Figure #15 -- |S22|dB -- ADS vs Matlab
